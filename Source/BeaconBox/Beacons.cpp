...
//                                  14.100        18.110        21.150        24.930        28.200        Beacon
  { "United Nations NY", CS_4U1UN,  00 * 60 + 00, 00 * 60 + 10, 00 * 60 + 20, 00 * 60 + 30, 00 * 60 + 40, B_4U1UN },
  { "Northern Canada",   CS_VE8AT,  00 * 60 + 10, 00 * 60 + 20, 00 * 60 + 30, 00 * 60 + 40, 00 * 60 + 50, B_VE8AT },
  { "USA (CA)",          CS_W6WX,   00 * 60 + 20, 00 * 60 + 30, 00 * 60 + 40, 00 * 60 + 50, 01 * 60 + 00, B_W6WX },  
  { "Hawaii",            CS_KH6RS,  00 * 60 + 30, 00 * 60 + 40, 00 * 60 + 50, 01 * 60 + 00, 01 * 60 + 10, B_KH6RS },
  { "New Zealand",       CS_ZL6B,   00 * 60 + 40, 00 * 60 + 50, 01 * 60 + 00, 01 * 60 + 10, 01 * 60 + 20, B_ZL6B },  
  { "West Australia",    CS_VK6RBP, 00 * 60 + 50, 01 * 60 + 00, 01 * 60 + 10, 01 * 60 + 20, 01 * 60 + 30, B_VK6RBP },  
  { "Japan",             CS_JA2IGY, 01 * 60 + 00, 01 * 60 + 10, 01 * 60 + 20, 01 * 60 + 30, 01 * 60 + 40, B_JA2IGY },  
  { "Siberia",           CS_RR90,   01 * 60 + 10, 01 * 60 + 20, 01 * 60 + 30, 01 * 60 + 40, 01 * 60 + 50, B_RR90 },    
  { "Hong Kong",         CS_VR2B,   01 * 60 + 20, 01 * 60 + 30, 01 * 60 + 40, 01 * 60 + 50, 02 * 60 + 00, B_VR2B},  
  { "Sri Lanka",         CS_4S7B ,  01 * 60 + 30, 01 * 60 + 40, 01 * 60 + 50, 02 * 60 + 00, 02 * 60 + 10, B_4S7B },  
  { "South Africa",      CS_ZS6DN,  01 * 60 + 40, 01 * 60 + 50, 02 * 60 + 00, 02 * 60 + 10, 02 * 60 + 20, B_ZS6DN }, 
  { "Kenya",             CS_5Z4B,   01 * 60 + 50, 02 * 60 + 00, 02 * 60 + 10, 02 * 60 + 20, 02 * 60 + 30, B_5Z4B }, 
  { "Isreal",            CS_4X6TU,  02 * 60 + 00, 02 * 60 + 10, 02 * 60 + 20, 02 * 60 + 30, 02 * 60 + 40, B_4X6TU },
  { "Finland",           CS_OH2B,   02 * 60 + 10, 02 * 60 + 20, 02 * 60 + 30, 02 * 60 + 40, 02 * 60 + 50, B_OH2B },
  { "Maderia",           CS_CS3B,   02 * 60 + 20, 02 * 60 + 30, 02 * 60 + 40, 02 * 60 + 50, 00 * 60 + 00, B_CS3B },
  { "Argentina",         CS_LU4AA,  02 * 60 + 30, 02 * 60 + 40, 02 * 60 + 50, 00 * 60 + 00, 00 * 60 + 10, B_LU4AA },
  { "Peru",              CS_OA4B,   02 * 60 + 40, 02 * 60 + 50, 00 * 60 + 00, 00 * 60 + 10, 00 * 60 + 20, B_OA4B },
  { "Venezuela",         CS_YV5B,   02 * 60 + 50, 00 * 60 + 00, 00 * 60 + 10, 00 * 60 + 20, 00 * 60 + 30, B_YV5B }
};
